...
export const products = [
  // bar processing category
  {
    ...
    model: "RB-600",
    image: {
      src: "/products/bpm/Automatic Bar Bender/1.webp",
...

  {
    ...
    model: "SSI - GW-42",
    image: {
      src: "/products/bpm/Automatic Bar Bending Machine/1.webp",
    ...
    specs: [
      { label: "Model Name/Number", value: "SSI - GW-42" },
      { label: "Max Bending Radius", value: "0-50 mm" },
      { label: "Voltage", value: "320 V" },
      { label: "Automation Grade", value: "Semi-Automatic" },
      { label: "Power", value: "Electric" },
      { label: "Brand", value: "Shree Shakti Infratech" },
      { label: "Model Name/Number", value: "SSI GW-50" },
      { label: "Bar Dimensions", value: "8mm to 40mm" },
      { label: "Max Bending Radius", value: "32MM" },
      { label: "Max Bending Angle", value: "32" },
      { label: "Power Source", value: "Electric" },
      { label: "Motor Speed", value: "2800 RPM" },
      { label: "Machine Weight", value: "270 KG" },
      { label: "TMT Bar Steel Dia.", value: "8mm - 32mm" },
...

  {
    ...
    model: "SSI - GW-42",
    image: {
      src: "/products/bpm/Automatic Rebar Bending Machine/1.webp",
...

  {
    ...
    model: "SSI - GW-50",
    image: {
      src: "/products/bpm/Bar Bending Machine Gw 50/1.webp",
      alt: "Bar Bending Machine GW-50",
    },
    images: [
      {
        src: "/products/bpm/Bar Bending Machine Gw 50/2.webp",
        alt: "Heavy Duty Bar Bending Machine GW-50",
      },
      {
        src: "/products/bpm/Bar Bending Machine Gw 50/3.webp",
        alt: "Automatic Rebar Bending Machine GW-50",
      },
    ],
    ...
    specs: [
      { label: "Model Name/Number", value: "SSI - GW-42" },
      { label: "Bar Dimensions", value: "8mm to 32 mm" },
      { label: "Max Bending Radius", value: "0-50 mm" },
      { label: "Power Source", value: "Electric" },
      { label: "Motor Speed", value: "2800 rpm" },
      { label: "Machine Weight", value: "350 kg" },
      { label: "Bending Speed", value: "3 sec / round" },
      { label: "TMT Bar Steel Dia.", value: "8 mm to 32 mm" },
      { label: "Motor Capacity", value: "5 h.p. three phase" },
      { label: "Bending Diameter", value: "32 mm" },
      { label: "Gear Oil", value: "6 ltr. 90 no." },
      { label: "Bender Set", value: "complete pin set" },
      { label: "Weight", value: "340 kg" },
      { label: "Voltage", value: "440 volt three phase" },
      { label: "Controlling System", value: "emergency switch" },
      { label: "Rotation Speed", value: "3 sec/ round" },
      { label: "Bending Range", value: "32 mm" },
      { label: "No. Of Bars", value: "4" },
      { label: "Phase", value: "Three phase" },
      { label: "Bending Capacity", value: "32 mm" },
      { label: "Automation Grade", value: "Semi-Automatic" },
      { label: "Body Material", value: "MS" },
      { label: "Power", value: "Electric" },
...

  {
    ...
    model: "SSI-GW-42",
    image: {
      src: "/products/bpm/Rod Bending Machine/Rod Bending Machine 28 Mm/1.webp",
      alt: "Automatic Rod Bending Machine",
    },
    images: [
      {
        src: "/products/bpm/Rod Bending Machine/Rod Bending Machine 28 Mm/2.webp",
        alt: "Rod Bending Machine Supplier",
      },
      {
        src: "/products/bpm/Rod Bending Machine/Rod Bending Machine 40mm/2.webp",
        alt: "Automatic Rod Bending Machine",
      },
    ],
    ...
    specs: [
      ...
      {
        label: "Max Bending Radius",
        value: "32MM",
      },
      {
        label: "Max Bending Angle",
        value: "32",
      },
      {
        label: "Power Source",
      ...
      {
        label: "Bar Dimensions (28mm Model)",
        value: "8mm to 32mm",
      },
      {
        label: "Motor Capacity (28mm Model)",
        value: "5 hp",
      },
    ],
...

  {
    ...
    model: "SSI - GW-42",
    image: {
      src: "/products/bpm/Sariya Binding Machine/Saria Bending Machine 32Mm/1.webp",
      alt: "Saria Bending Machine 32 Mm",
    },
    images: [
      {
        src: "/products/bpm/Sariya Binding Machine/Saria Bending Machine 32Mm/2.webp",
        alt: "Saria Bending Machine 32 Mm",
      },
      {
        src: "/products/bpm/Sariya Binding Machine/Saria Bending Machine 32Mm/3.webp",
        alt: "Saria Bending Machine 32 Mm",
      },
    ],
...

  {
    ...
    model: "SSI - GW-42",
    image: {
      src: "/products/bpm/Sariya Binding Machine/Saria Bending Machine 40 Mm/1.webp",
      alt: "Saria Bending Machine 40 Mm",
    },
    images: [
      {
        src: "/products/bpm/Sariya Binding Machine/Saria Bending Machine 40 Mm/2.webp",
        alt: "Saria Bending Machine 40 Mm",
      },
      {
        src: "/products/bpm/Sariya Binding Machine/Saria Bending Machine 40 Mm/3.webp",
        alt: "Saria Bending Machine 40 Mm",
      },
    ],
...

  {
    ...
    model: "SSI - RM-32",
    image: {
      src: "/products/bpm/semi ring phase/1.webp",
      alt: "Single Phase Ring Making Machine",
    },
    ...
    specs: [
      ...
      {
        label: "Min Finish Wire Diameter",
        value: "3-4 mm",
      },
      {
        label: "Make",
...

  {
    ...
    model: "SSI - GWH-032",
    image: {
      src: "/products/bpm/SPIRAL BENDING MACHINE/1.webp",
      alt: "Spiral Bending Machine",
    },
...

  {
    ...
    model: "SSI - GW-42",
    image: {
      src: "/products/bpm/Steel Rebar Bender/1.webp",
      alt: "Steel Bar Bending Machine 25Mm",
    },
...

  {
    ...
    model: "SSI - GW-42",
    image: {
      src: "/products/bpm/Steel Rebar Bender/2.webp",
      alt: "Steel Rebar Bending Machine 32Mm",
    },
...

  {
    ...
    model: "SSI - GW-42",
    image: {
      src: "/products/bpm/Stirrup Making Machine/1.webp",
      alt: "Stirrup Bar Rod Bending Machine",
    },
    images: [
      {
        src: "/products/bpm/Stirrup Making Machine/2.webp",
        alt: "Stirrup Bar Rod Bending Machine",
      },
      {
        src: "/products/bpm/Stirrup Making Machine/3.webp",
        alt: "Stirrup Bar Rod Bending Machine",
      },
    ],
    ...
    specs: [
      ...
      { label: "Usage/Application", value: "Stirrups" },
      { label: "Capacity", value: "32mm" },
...

  {
    ...
    model: "SSI GW 42",
    image: {
      src: "/products/bpm/Rod Bending Machine/1.webp",
      alt: "TMT Bar Bending Machine",
    },
    images: [
      {
        src: "/products/bpm/Rod Bending Machine/2.webp",
        alt: "TMT Bar Bending Machine",
      },
    ],
    ...
    specs: [
      { label: "Model Name/Number", value: "SSI GW 42" },
      { label: "Bar Dimensions", value: "8mm to 32mm" },
      { label: "Max Bending Radius", value: "32" },
      { label: "Power Source", value: "Electric" },
      { label: "Brand", value: "Shree Shakti Infratech" },
    ],
...

  {
    ...
    model: "RB-700",
    image: {
      src: "/products/asg/Anti-Fog-Cannon-Machine/1.webp",
      alt: "Anti-Fog Cannon Machine",
    },
    images: [
      {
        src: "/products/asg/Anti-Fog-Cannon-Machine/2.webp",
        alt: "Anti-Fog Cannon Machine",
      },
      {
        src: "/products/asg/Anti-Fog-Cannon-Machine/3.webp",
        alt: "Anti-Fog Cannon Machine",
      },
    ],
    ...
    specs: [
      ...
      { label: "Water Pump Power", value: "2hp" },
      { label: "Rotation Angle", value: "90" },
      { label: "Elevation Angle", value: "60" },
...

  {
    ...
    model: "RB-11200",
    image: {
      src: "/products/asg/Fog-Cannon-Dust-Suppression-System/1.webp",
      alt: "Fog Cannon Dust Suppression System",
    },
    images: [
      {
        src: "/products/asg/Fog-Cannon-Dust-Suppression-System/2.webp",
        alt: "Fog Cannon Dust Suppression System",
      },
    ],
    ...
    specs: [
      ...
      { label: "Material", value: "Mild Steel" },
      { label: "Color", value: "Yellow" },
      { label: "Drive Unit", value: "Manually and Tractor Attached" },
      { label: "Brand", value: "SSI" },
      { label: "Country of Origin", value: "Made in India" },
      { label: "Range", value: "25-30 mtr." },
      { label: "Water Pump ", value: "2hp CRI" },
      { label: "Main Motor", value: "5 hp three phase" },
...

  {
    ...
    model: "SSI - SG-01",
    image: {
      src: "/products/asg/Fog-Cannon-Spray-Machine/1.webp",
      alt: "Fog Cannon Spray Machine",
    },
    images: [
      {
        src: "/products/asg/Fog-Cannon-Spray-Machine/2.webp",
        alt: "Fog Cannon Spray Machine",
      },
      {
        src: "/products/asg/Fog-Cannon-Spray-Machine/3.webp",
        alt: "Fog Cannon Spray Machine",
      },
    ],
    ...
    specs: [
      ...
      { label: "Brand", value: "SSI - SG-01" },
      { label: "Droplet Size", value: "1.5" },
      { label: "Voltage", value: "440 volt" },
      { label: "Country of Origin", value: "Made in India" },
      { label: "Range", value: "30 metre" },
      { label: "Rotation", value: "360°" },
      { label: "Water Motor", value: "5 hp" },
      { label: "Water Pump", value: "2 hp" },
      { label: "Water Tank", value: "1000 ltr" },
...

  {
    ...
    model: "SSI",
    image: {
      src: "/products/asg/Mist-Cannon-Dust-Suppression-Systems/1.webp",
      alt: "Mist Cannon Dust Suppression Systems",
    },
    images: [
      {
        src: "/products/asg/Mist-Cannon-Dust-Suppression-Systems/2.webp",
        alt: "Mist Cannon Dust Suppression Systems",
      },
    ],
    ...
    specs: [
      { label: "Power Consumption", value: "5 hp three phase" },
      { label: "Usage", value: "Air Pollution Control" },
      { label: "Type", value: "4 wheel type" },
      { label: "Material", value: "Mild Steel" },
      { label: "Color", value: "Yellow" },
      { label: "Automation Grade", value: "Semi Automatic" },
      { label: "Drive Unit", value: "Manually and Tractor Attached" },
...

  {
    ...
    model: "SSI",
    image: {
      src: "/products/asg/Truck-Mounted-Anti-Smog-Gun/1.webp",
      alt: "Truck Mounted Anti Smog Gun",
    },
    images: [
      {
        src: "/products/asg/Truck-Mounted-Anti-Smog-Gun/2.webp",
        alt: "Truck Mounted Anti Smog Gun",
      },
      {
        src: "/products/asg/Truck-Mounted-Anti-Smog-Gun/3.webp",
        alt: "Truck Mounted Anti Smog Gun",
      },
    ],
...

  {
    ...
    model: "SSI",
    image: {
      src: "/products/asg/Water-Fog-And-Water-Mist-Systems/1.webp",
      alt: "Water Fog And Water Mist Systems",
    },
    images: [
      {
        src: "/products/asg/Water-Fog-And-Water-Mist-Systems/2.webp",
        alt: "Water Fog And Water Mist Systems",
      },
    ],
    ...
    specs: [
      { label: "Material", value: "MS Steel" },
      { label: "Automation Grade", value: "Semi-Automatic" },
      { label: "Finishing", value: "Dust finishing" },
      { label: "Flow Rate", value: "50 - 150" },
      { label: "Brand", value: "SSI" },
      { label: "Color", value: "Yellow" },
      { label: "Temperature", value: "30°C" },
      { label: "Capacity", value: "1000 ltr" },
...

  {
    ...
    model: "SSI MX 05",
    image: {
      src: "/products/cm/2PoleTowerLiftConcreteMixerMachine/1.webp",
      alt: "2 Pole Tower Lift Concrete Mixer Machine",
    },
    images: [
      {
        src: "/products/cm/2PoleTowerLiftConcreteMixerMachine/2.webp",
        alt: "2 Pole Tower Lift Concrete Mixer Machine side view",
      },
    ],
    description: [
      {
    ...
    specs: [
      ...
      { label: "Capacity", value: "560 ltr" },
      { label: "Automation Grade", value: "Semi-Automatic" },
      { label: "Machine Type", value: "Concrete" },
      { label: "Brand", value: "Kirloskar" },
      { label: "Model Name/Number", value: "SSI MX 05" },
      { label: "Mixer Type", value: "Reversible Drum Type" },
      { label: "Weight", value: "1800 kg" },
      { label: "Output Capacity", value: "560 Liters" },
...

  {
    ...
    model: "SSI-MX-10",
    image: {
      src: "/products/cm/3 BIN MIXER LIFT WITH HYDRAULIC HOPPER/1.webp",
      alt: "3 BIN MIXER LIFT WITH HYDRAULIC HOPPER",
    },
    images: [
      {
        src: "/products/cm/3 BIN MIXER LIFT WITH HYDRAULIC HOPPER/2.webp",
    ...
    specs: [
      ...
      {
        label: "Capacity",
        value: "Unmixed: 10Cft, Mixed: 7Cft / 1 Bag Cement",
      },
      { label: "Engine", value: "14HP Diesel Engine" },
      { label: "Height", value: "10-65 Feet (Extendable)" },
      { label: "Wire Rope", value: "12mm Mahadeva / Usha marting" },
...

  {
    ...
    model: "SSI-MX-01-02",
    image: {
      src: "/products/cm/180230Ltr. MINI CONCRETE MIXER/1.webp",
      alt: "180/230Ltr. MINI CONCRETE MIXER",
    },
    images: [
      {
        src: "/products/cm/180230Ltr. MINI CONCRETE MIXER/2.webp",
        alt: "180/230Ltr. MINI CONCRETE MIXER side view",
      },
      {
        src: "/products/cm/180230Ltr. MINI CONCRETE MIXER/3.webp",
        alt: "180/230Ltr. MINI CONCRETE MIXER operation",
      },
    ],
    description: [
      {
    ...
    specs: [
      ...
      { label: "Capacity", value: "180 / 230 Ltr" },
      { label: "Motor", value: "900 / 650W" },
      { label: "Drum Size", value: "26 inch / 70 inch" },
...

  {
    ...
    model: "SSI-CBL-01",
    image: {
      src: "/products/cm/COLUMN BOX LIFT MACHINE/1.webp",
      alt: "COLUMN BOX LIFT MACHINE",
    },
    images: [
      {
        src: "/products/cm/COLUMN BOX LIFT MACHINE/2.webp",
        alt: "COLUMN BOX LIFT MACHINE side view",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Height", value: "35Ft. / As Per Customer" },
      { label: "Prime Mover", value: "3kW" },
      { label: "Rope", value: "10mm Mahadeva" },
...

  {
    ...
    model: "SSI-MB-01",
    image: {
      src: "/products/cm/Concrete Mini Mobile Batching Plant/1.webp",
      alt: "Concrete Mini Mobile Batching Plant",
    },
    images: [
      {
        src: "/products/cm/Concrete Mini Mobile Batching Plant/2.webp",
        alt: "Concrete Mini Mobile Batching Plant side view",
      },
    ],
    description: [
      {
    ...
    specs: [
      ...
      { label: "Automation Grade", value: "Semi-Automatic" },
      { label: "Brand", value: "SSI" },
      { label: "Output Capacity", value: "1200 Liters" },
      { label: "Type Of The Drum Mixer", value: "Reverse Drum Mixer" },
...

  {
    ...
    images: [
      {
        src: "/products/cm/CONCRETE MIXER/2.webp",
        alt: "Concrete Mixer side view",
      },
      {
        src: "/products/cm/CONCRETE MIXER/3.webp",
        alt: "Concrete Mixer operation",
      },
    ],
    ...
    specs: [
      ...
      { label: "Capacity", value: "10/7 Cft. / One Bag" },
      { label: "Motor", value: "5HP (Compton/Kirloskar)" },
      { label: "Pneumatic Wheels", value: "4pcs" },
      { label: "Engine", value: "6.5HP (Kirloskar)" },
      { label: "Special Feature", value: "Heavy Duty Along with Wheel" },
      { label: "Drum Size", value: "10mm-8mm-4mm" },
...

  {
    ...
    model: "SSI-MX-06",
    image: {
      src: "/products/cm/CONCRETE MIXER HYDRAULIC HOPPER/1.webp",
      alt: "Concrete Mixer Hydraulic Hopper",
    },
    images: [
      {
        src: "/products/cm/CONCRETE MIXER HYDRAULIC HOPPER/2.webp",
        alt: "Concrete Mixer Hydraulic Hopper side view",
      },
    ],
    description: [
      {
    ...
    specs: [
      ...
      { label: "Capacity", value: "8HP" },
      { label: "Motor", value: "7.5 HP, 3Phase" },
      { label: "Drum Size", value: "10mm-8mm-4mm" },
      { label: "Drum Capacity", value: "560 Ltr (Approx)" },
    ],
...

  {
    ...
    model: "SSI-MX-07",
    image: {
      src: "/products/cm/CONCRETE MIXER LIFT/1.webp",
      alt: "Concrete Mixer Lift",
    },
    images: [
      {
        src: "/products/cm/CONCRETE MIXER LIFT/2.webp",
        alt: "Concrete Mixer Lift side view",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Engine", value: "Kiloskar 10HP" },
      { label: "Make", value: "SSI" },
      { label: "Type", value: "2 Channel" },
      { label: "Channel Size", value: "100 x 50mm" },
      { label: "Angle Size", value: "40 x 5mm" },
...

  {
    ...
    model: "SSI-MB-01",
    image: {
      src: "/products/cm/Concrete Mobile Batching Plant/1.webp",
      alt: "Concrete Mobile Batching Plant",
    },
    images: [
      {
        src: "/products/cm/Concrete Mobile Batching Plant/2.webp",
        alt: "Concrete Mobile Batching Plant operation",
      },
    ],

    videoUrl: "https://youtu.be/H0OJRc7C_v8?si=4UGx3HeUDuZDKdaa",
...

  {
    ...
    model: "SSI-MX-11",
    image: {
      src: "/products/cm/FOUR POLE MIXER LIFT/1.webp",
      alt: "FOUR POLE MIXER LIFT",
    },
    ...
    specs: [
      ...
      { label: "Drum Capacity", value: "10/7 CFT 1 Bag" },
      { label: "Mixture Drum", value: "Heavy Duty with Bearing & MS Blades" },
      { label: "Power", value: "10hp Electric Motor / 10hp Diesel Engine" },
      { label: "Machine Structure", value: "ISI Grade Steel Body" },
      { label: "Break", value: "Friction Clutch, Dog Lock, Leather Break" },
...

  {
    ...
    model: "SSI-MB-01",
    image: {
      src: "/products/cm/Mini Mobile Batching/Mini Mobile Concrete Batching Plant Rm800/1.webp",
      alt: "Mini Mobile Batching Plant",
    },
    images: [
      {
        src: "/products/cm/Mini Mobile Batching/Mini Mobile Concrete Batching Plant Rm800/2.webp",
        alt: "Mini Mobile Batching Plant side view",
      },
      {
        src: "/products/cm/Mini Mobile Batching/Mini Mobile Concrete Batching Plant On Sale/2.webp",
        alt: "Mini Mobile Batching Plant operation",
      },
    ],
    ...
    specs: [
      ...
      { label: "Automation Grade", value: "Semi-Automatic" },
      { label: "Brand", value: "SSI" },
      { label: "Mixer Type", value: "Reversible type" },
      { label: "Output Capacity", value: "1200 Liters" },
      { label: "Type Of The Drum Mixer", value: "Reverse Drum Mixer" },
      { label: "Model Name/Number", value: "SSI-MB-01" },
      { label: "Capacity", value: "10 mc3/hr" },
...

  {
    ...
    model: "SSI-MX-05",
    image: {
      src: "/products/cm/CONCRETE MIXER WITH HOPPER/1.webp",
      alt: "Concrete Mixer with Hopper",
    },
    images: [
      {
        src: "/products/cm/CONCRETE MIXER WITH HOPPER/2.webp",
        alt: "Heavy Duty Concrete Mixer with Hopper",
      },
      {
        src: "/products/cm/CONCRETE MIXER WITH HOPPER/3.webp",
        alt: "Concrete Mixer Machine for Construction",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Capacity", value: "10/7 Cft / One Bag" },
      { label: "Motor", value: "5 HP, 3 Phase" },
      { label: "Engine", value: "8 HP (Optional)" },
      { label: "Total Weight", value: "1000 Kg" },
      { label: "Drum Size", value: "10mm - 8mm - 4mm" },
      { label: "Drum Capacity", value: "560 Ltr (Approx)" },
      { label: "Automation Grade", value: "Mechanical with Hydraulic Hopper" },
      { label: "Mobility", value: "Along with Wheels & Heavy Duty Mechanical" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-MX-09",
    image: {
      src: "/products/cm/MIXER LIFT WITH HYDRAULIC HOPPER/1.webp",
      alt: "Mixer Lift with Hydraulic Hopper",
    },
    images: [
      {
        src: "/products/cm/MIXER LIFT WITH HYDRAULIC HOPPER/2.webp",
        alt: "Mixer Lift with Hydraulic Hopper side view",
      },
      {
        src: "/products/cm/MIXER LIFT WITH HYDRAULIC HOPPER/3.webp",
    ...
    specs: [
      ...
      { label: "Capacity", value: "Unmixed: 10Cft Mixed: 7Cft" },
      { label: "Engine", value: "10HP Diesel Engine" },
      { label: "Height", value: "10-65 Feet (Extendable)" },
      { label: "Wire Rope", value: "12mm Mahadeva / Usha Martin" },
...

  {
    ...
    model: "SSI-MX-12",
    image: {
      src: "/products/cm/PAN MIXER/1.webp",
      alt: "Pan Mixer",
    },
    images: [
      {
        src: "/products/cm/PAN MIXER/2.webp",
        alt: "Pan Mixer side view",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Charging Capacity", value: "350 Ltr" },
      { label: "Discharging Capacity", value: "250 Ltr" },
      { label: "Power", value: "5kw 415v" },
      { label: "Max. Grain Size", value: "60mm" },
...

  {
    ...
    model: "SSI-MB-01",
    image: {
      src: "/products/cm/Reversible Mini Batching Plant/1.webp",
      alt: "Mobile RM 800 System",
    },
    images: [
      {
        src: "/products/cm/Reversible Mini Batching Plant/2.webp",
        alt: "Mobile RM 800 System side view",
      },
    ],
...

  {
    ...
    model: "SSI-MB-02",
    image: {
      src: "/products/cm/REVERSIBLE MIXER RM 1050/1.webp",
      alt: "Reversible Mixer RM 1050",
    },
    images: [
      {
        src: "/products/cm/REVERSIBLE MIXER RM 1050/2.webp",
        alt: "Reversible Mixer RM 1050 side view",
      },
      {
        src: "/products/cm/REVERSIBLE MIXER RM 1050/3.webp",
        alt: "Reversible Mixer RM 1050 operation",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Capacity", value: "15M3 /HR" },
      { label: "Type", value: "Reversible Drum" },
      { label: "Tyre Mounted", value: "04 Tyre’s" },
      { label: "Drum Motor", value: "12.5 HP" },
      { label: "Water Motor", value: "1 HP" },
      { label: "Additive Motor", value: "0.5 HP" },
      { label: "Vibrator Motor", value: "0.05 HP" },
...

  {
    ...
    model: "SSI-MB-01",
    image: {
      src: "/products/cm/Rmc Mixing Mobile Batching Plant/1.webp",
      alt: "RMC Mixing Mobile Batching Plant",
    },
    images: [
      {
        src: "/products/cm/Rmc Mixing Mobile Batching Plant/2.webp",
        alt: "RMC Mixing Mobile Batching Plant side view",
      },
    ],
    description: [
      {
...

  {
    ...
    image: {
      ...
      alt: "Half Bag Concrete Mixer",
    },
    images: [
      {
        src: "/products/cm/HALF BAG CONCRETE MIXER/2.webp",
        alt: "Portable Half Bag Concrete Mixer Machine",
      },
      {
        src: "/products/cm/HALF BAG CONCRETE MIXER/3.webp",
        alt: "Half Bag Concrete Mixer for Construction",
      },
    ],
    ...
    specs: [
      ...
      { label: "Capacity", value: "Half Bag" },
      { label: "Motor", value: "2 HP, Single Phase / Three Phase" },
      { label: "Wheel", value: "4 Nos" },
      { label: "Automation Grade", value: "Manual Operation" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-CTM-200D",
    image: {
      src: "/products/lte/C.T.M 100 TON  200 TON/1.webp",
      alt: "200 Ton Digital Compression Testing Machine",
    },
    images: [
      {
        src: "/products/lte/C.T.M 100 TON  200 TON/2.webp",
        alt: "200 Ton Digital Compression Testing Machine front view",
      },
      {
        src: "/products/lte/C.T.M 100 TON  200 TON/3.webp",
        alt: "200 Ton Digital Compression Testing Machine in laboratory",
      },
    ],
    description: [
      {
...

  {
    ...
    model: "SSI-CM-150",
    image: {
      src: "/products/lte/CUBE MOULD/1.webp",
      alt: "Concrete Cube Mould",
    },
    images: [
      {
        src: "/products/lte/CUBE MOULD/2.webp",
        alt: "Concrete Cube Mould cast iron build",
      },
      {
        src: "/products/lte/CUBE MOULD/3.webp",
        alt: "Concrete Cube Mould square shape",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Shaping Mode Type", value: "Square" },
      { label: "Operating Mode", value: "Manual" },
...

  {
    ...
    model: "SSI-HAO-01",
    image: {
      src: "/products/lte/HOT AIR OVEN/1.webp",
      alt: "Hot Air Oven",
    },
    ...
    specs: [
      ...
      { label: "Chamber Material", value: "Stainless Steel (SS 304)" },
      { label: "Outer Material", value: "Mild Steel with Powder Coating" },
      { label: "Heating Method", value: "Forced Air Circulation" },
      { label: "Accuracy", value: "±1°C" },
      { label: "Safety Features", value: "Overheat Protection, Auto Cut-off" },
      { label: "Operating Mode", value: "Manual / Digital Control" },
...

  {
    ...
    model: "SSI-IT-01",
    image: {
      src: "/products/lte/IMPACT TESTER/1.webp",
      alt: "Impact Tester",
    },
    ...
    specs: [
      ...
      { label: "Testing Standards", value: "ASTM, ISO, IS" },
      { label: "Type of Tests", value: "Charpy & Izod" },
      { label: "Capacity", value: "Up to 300 Joules" },
      { label: "Accuracy", value: "±1%" },
      { label: "Material", value: "Heavy-duty Mild Steel" },
      { label: "Operating Mode", value: "Manual / Semi-Automatic" },
      { label: "Model Name/Number", value: "SSI-IT-01" },
...

  {
    ...
    model: "SSI-RMM-01",
    image: {
      src: "/products/lte/RAPID MOISTURE METER/1.webp",
      alt: "Rapid Moisture Meter",
    },
    ...
    specs: [
      ...
      { label: "Material", value: "Mild Steel / Aluminium" },
      { label: "Capacity", value: "25g, 50g, 100g soil samples" },
      { label: "Display Type", value: "Analog Gauge" },
      { label: "Operating Mode", value: "Manual" },
      { label: "Accuracy", value: "±0.2%" },
      {
        label: "Accessories Supplied",
        value: "Pressure Gauge, Moisture Bottles, Sealing Rings",
      },
      { label: "Model Name/Number", value: "SSI-RMM-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-SS-01",
    image: {
      src: "/products/lte/SIEVE SHAKER/1.webp",
      alt: "Laboratory Sieve Shaker",
    },
    ...
    specs: [
      {
        label: "Usage/Application",
        value: "Soil, Aggregate, and Sand Testing",
      },
      { label: "Material", value: "Mild Steel / Stainless Steel" },
      { label: "Capacity", value: "Up to 8 Sieves (200 mm / 300 mm dia)" },
      { label: "Operating Mode", value: "Motorized / Manual" },
      { label: "Power Supply", value: "220V AC, Single Phase" },
      { label: "Motor Power", value: "0.25 HP" },
      { label: "Model Name/Number", value: "SSI-SS-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-SC-01",
    image: {
      src: "/products/lte/SLUMP CONE/1.webp",
      alt: "Slump Cone Apparatus",
    },
    images: [
      {
        src: "/products/lte/SLUMP CONE/2.webp",
        alt: "Concrete Slump Cone Test Apparatus",
      },
    ],
    description: [
    ...
    specs: [
      ...
      {
        label: "Cone Size",
        value: "300mm height x 200mm bottom dia x 100mm top dia",
      },
      { label: "Tamping Rod", value: "16mm dia x 600mm length" },
      { label: "Base Plate", value: "Square, rigid, detachable" },
      { label: "Operating Mode", value: "Manual" },
      { label: "Model Name/Number", value: "SSI-SC-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-WB-01",
    image: {
      src: "/products/lte/WEIGHT BALANCE MACHINE/1.webp",
      alt: "Weight Balance Machine",
    },
    images: [
      {
        src: "/products/lte/WEIGHT BALANCE MACHINE/2.webp",
        alt: "Digital Weight Balance Machine",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Type", value: "Digital / Mechanical" },
      { label: "Capacity Range", value: "1 kg – 50 kg" },
      { label: "Accuracy", value: "0.01 g to 1 g (depending on model)" },
      { label: "Display", value: "Digital LCD / LED" },
      { label: "Power Supply", value: "AC / Rechargeable Battery" },
      { label: "Material", value: "Stainless Steel Pan with Rigid Body" },
      { label: "Model Name/Number", value: "SSI-WB-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
  ...
  // new product
  {
    ...
    image: {
      src: "/products/lte/SIEVESBRASS/1.webp",
      alt: "Sieve Shaker GI/Brass",
    },
    images: [
      {
        src: "/products/lte/SIEVESBRASS/2.webp",
        alt: "Laboratory Sieve Shaker Brass Model",
      },
    ],
    ...
    specs: [
      { label: "Model", value: "SSI-SS-01" },
      { label: "Material Options", value: "GI (Galvanized Iron) / Brass" },
      {
        label: "Sieve Sizes",
        value: "75 micron to 4.75 mm (as per IS/BS/ASTM standards)",
      },
      {
        label: "Application",
        value: "Soil, Cement, Aggregate, and Material Testing",
      },
  ...
  // new product
  {
    ...
    specs: [
      ...
      { label: "Usage", value: "Laboratory / Field" },
      { label: "Is It Portable", value: "Portable" },
      { label: "Range", value: "10 to 100 Rebound Number" },
      { label: "Brand", value: "SSI" },
    ],
...

  {
    ...
    model: "SSI-CT-01",
    image: {
      src: "/products/si/Caution Tape/1.webp",
      alt: "Caution Tape for Safety",
    },
    ...
    specs: [
      ...
      { label: "Color Options", value: "Yellow, Red, White (with bold text)" },
      { label: "Length", value: "100m, 200m (custom available)" },
      { label: "Width", value: "3 inch / 75mm (standard)" },
      {
        label: "Usage/Application",
        value: "Safety, Hazard Marking, Barricading",
      },
      { label: "Model Name/Number", value: "SSI-CT-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-GB-01",
    image: {
      src: "/products/si/Gum Boot/1.webp",
      alt: "Industrial Safety Gum Boot",
    },
    ...
    specs: [
      ...
      { label: "Design", value: "Knee Length / Ankle Length" },
      { label: "Sole", value: "Anti-Slip, Oil Resistant" },
      { label: "Color Options", value: "Black, White, Yellow" },
      {
        label: "Usage/Application",
        value: "Construction, Industrial, Agriculture, Chemical Plants",
      },
      { label: "Model Name/Number", value: "SSI-GB-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    specs: [
      ...
      { label: "Type", value: "Full Body / Half Body Safety Belt" },
      { label: "Lanyard", value: "Single / Double with Shock Absorber" },
      {
        label: "Usage/Application",
        value: "Construction, Industrial, Telecom, Electrical, Rescue",
      },
      { label: "Model Name/Number", value: "SSI-SB-01" },
      { label: "Color Options", value: "Orange, Yellow, Green" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-SG-01",
    image: {
      src: "/products/si/Safety Gloves/1.webp",
      alt: "Industrial Safety Gloves",
    },
    images: [
      {
        src: "/products/si/Safety Gloves/2.webp",
        alt: "Rubber Safety Gloves for Construction",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Cuff Length", value: "1-5 Inches" },
      { label: "Quality", value: "Medium" },
      { label: "Model Name/Number", value: "SSI-SG-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-SH-01",
    image: {
      src: "/products/si/Safety Helmet/1.webp",
    ...
    specs: [
      ...
      { label: "Color Options", value: "Yellow, White, Blue, Green, Red" },
      { label: "Material", value: "ABS / HDPE" },
      { label: "Size", value: "Adjustable (Universal Fit)" },
      { label: "Chin Strap", value: "Yes" },
...

  {
    ...
    model: "SSI-SJ-01",
    image: {
      src: "/products/si/Safety Jacket/1.webp",
      alt: "Reflective Safety Jacket",
    },
    ...
    specs: [
      {
        label: "Usage/Application",
        value: "Construction / Industrial / Road Safety",
      },
      { label: "Material", value: "Polyester / Mesh Fabric" },
      { label: "Size", value: "Small, Medium, Large, XL" },
      { label: "Color Options", value: "Orange, Green, Yellow" },
      { label: "Reflective Strips", value: "Yes" },
      { label: "Closure Type", value: "Velcro / Zipper" },
      { label: "Model Name/Number", value: "SSI-SJ-01" },
      { label: "Country of Origin", value: "Made in India" },
    ],
...

  {
    ...
    model: "SSI-SN-01",
    image: {
      src: "/products/si/Safety Net/1.webp",
      alt: "Construction Safety Net",
    },
    images: [
      {
        src: "/products/si/Safety Net/2.webp",
        alt: "Industrial Safety Net",
      },
    ],
    description: [
    ...
    specs: [
      {
        label: "Usage/Application",
        value: "Construction / Industrial / Fall Protection",
      },
      { label: "Material", value: "Nylon / HDPE" },
      { label: "Color Options", value: "Green, Orange, Blue" },
      { label: "Mesh Size", value: "Available in multiple sizes" },
      { label: "Knot Type", value: "Double/Single" },
...

  {
    ...
    image: {
      src: "/products/si/halfboots.avif",
      alt: "safety boots",
    },
  ...
  // surveying instruments
  {
    ...
    model: "SSI-AL-01",
    image: {
      src: "/products/survey/Auto Level/1.webp",
      alt: "Auto Level Surveying Instrument",
    },
    images: [
      {
        src: "/products/survey/Auto Level/2.webp",
        alt: "Automatic Level for Surveying",
      },
      {
        src: "/products/survey/Auto Level/3.webp",
        alt: "Surveying Auto Level Equipment",
      },
    ],
    description: [
    ...
    specs: [
      {
        label: "Usage/Application",
        value: "Surveying / Construction / Civil Engineering",
      },
      { label: "Magnification", value: "20X / 24X / 32X" },
      { label: "Leveling", value: "Automatic Compensator" },
      { label: "Accuracy", value: "±2.0 mm per km double-run leveling" },
      { label: "Material", value: "Metal & Optical Glass" },
      { label: "Model Name/Number", value: "SSI-AL-01" },
      { label: "Accessories", value: "Tripod, Staff, Carrying Case" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-DL-01",
    image: {
      src: "/products/survey/Dumpy Level/1.webp",
      alt: "Dumpy Level Surveying Instrument",
    },
    ...
    specs: [
      ...
      { label: "Magnification", value: "20X / 24X / 32X" },
      { label: "Leveling", value: "Manual Bubble Leveling" },
      { label: "Accuracy", value: "±2.5 mm per km double-run leveling" },
      { label: "Material", value: "Metal with Optical Glass" },
      { label: "Model Name/Number", value: "SSI-DL-01" },
      { label: "Accessories", value: "Tripod, Staff, Carrying Case" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-TD-01",
    image: {
      src: "/products/survey/Theodolites  Manual  Digital/3.webp",
      alt: "Theodolite Manual Digital Surveying Instrument",
    },
    images: [
      {
        src: "/products/survey/Theodolites  Manual  Digital/2.webp",
        alt: "Manual Theodolite for Surveying",
      },
      {
        src: "/products/survey/Theodolites  Manual  Digital/1.webp",
        alt: "Digital Theodolite with Tripod",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Magnification", value: "20X / 24X / 30X" },
      {
        label: "Angle Measurement Accuracy",
        value: "2” to 5” (depending on model)",
      },
      { label: "Display (Digital Models)", value: "Dual Side LCD Display" },
      { label: "Material", value: "Metal with Optical Glass" },
      { label: "Model Name/Number", value: "SSI-TD-01" },
...

  {
    ...
    model: "SSI-TS-01",
    image: {
      src: "/products/survey/Total Station/1.webp",
      alt: "Total Station Surveying Instrument",
    },
    ...
    specs: [
      ...
      { label: "Type", value: "Electronic Total Station" },
      {
        label: "Angle Measurement Accuracy",
        value: "1” / 2” / 5” (depending on model)",
      },
      { label: "Distance Measurement Range", value: "Up to 5 km with prism" },
      { label: "Data Storage", value: "Internal memory + USB" },
      { label: "Display", value: "Dual Side LCD" },
      { label: "Power Supply", value: "Rechargeable Battery" },
      { label: "Model Name/Number", value: "SSI-TS-01" },
      { label: "Accessories", value: "Tripod, Prism, Carrying Case" },
      { label: "Country of Origin", value: "Made in India" },
    ],
    metaTitle:
...

  {
    ...
    specs: [
      ...
      { label: "Tripod Material", value: "Aluminium / Wooden" },
      { label: "Tripod Height Adjustment", value: "Up to 1.8 m" },
      { label: "Staff Length", value: "3m / 4m / 5m (Telescopic)" },
      { label: "Staff Material", value: "Aluminium / Wooden" },
      { label: "Graduation", value: "Clear markings for easy readings" },
...

  {
    ...
    model: "SSI-SMT-S600",
    image: {
      src: "/products/ror/DOUBLE DRUM ROLLER ( WALK BEHIND)/1.webp",
      alt: "Double Drum Roller Walk Behind",
    },
    images: [
      {
        src: "/products/ror/DOUBLE DRUM ROLLER ( WALK BEHIND)/2.webp",
        alt: "Walk Behind Double Drum Roller front view",
      },
      {
        src: "/products/ror/DOUBLE DRUM ROLLER ( WALK BEHIND)/3.webp",
    ...
    specs: [
      ...
      { label: "Walking Speed", value: "0-4 Km/H" },
      { label: "Centrifugal Force", value: "13.5 KN" },
      { label: "Compaction of Soil", value: "30 cm" },
      { label: "Vibration Frequency", value: "70 HZ" },
      { label: "Water Tank Capacity", value: "35 L" },
      { label: "Weight", value: "550 Kg Approx" },
      {
        label: "Power Source",
        value: "Diesel Engine / Petrol Engine (Optional)",
      },
      { label: "Automation Grade", value: "Walk Behind Manual Control" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-PC01/02",
    image: {
      src: "/products/ror/PLATE COMPACTOR ( ELECTRIC  DIESEL)/1.webp",
      alt: "Plate Compactor Electric Diesel",
    },
    images: [
      {
        src: "/products/ror/PLATE COMPACTOR ( ELECTRIC  DIESEL)/2.webp",
        alt: "Heavy Duty Plate Compactor for soil and asphalt",
      },
      {
        src: "/products/ror/PLATE COMPACTOR ( ELECTRIC  DIESEL)/3.webp",
        alt: "Electric and Diesel Plate Compactor front view",
      },
    ],
    description: [
      {
    ...
    specs: [
      ...
      { label: "Frequency", value: "7000 bpm" },
      { label: "Compaction Depth", value: "12 inch Approx" },
      { label: "Plate Size", value: "42 x 60 cm" },
      { label: "Efficiency", value: "770 m²/hour Approx" },
      { label: "Total Weight", value: "120 Kg Approx" },
      { label: "Automation Grade", value: "Manual Walk-Behind" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-SMT-700",
    image: {
      src: "/products/ror/ride/1.webp",
      alt: "Ride On Roller for road compaction",
    },
    images: [
      {
        src: "/products/ror/ride/2.webp",
        alt: "Heavy Duty Ride On Roller side view",
      },
      {
        src: "/products/ror/ride/3.webp",
        alt: "Ride On Roller for soil and asphalt compaction",
      },
      {
        src: "/products/ror/ride/4.webp",
        alt: "Construction Ride On Roller machine",
      },
    ],
    ...
    specs: [
      ...
      { label: "Walking/Driving Speed", value: "0-4 Km/H" },
      { label: "Centrifugal Force", value: "25 KN" },
      { label: "Driving Motor", value: "Hydraulic" },
      { label: "Vibration Frequency", value: "70 HZ" },
      { label: "Water Tank Capacity", value: "15 L" },
      { label: "Weight", value: "700 Kg Approx" },
      {
        label: "Power Source",
        value: "Diesel Engine / Petrol Engine (Optional)",
      },
      { label: "Automation Grade", value: "Ride On Hydraulic Control" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-SMT-600",
    image: {
      src: "/products/ror/SINGLE DRUM VIBRATOR ROLLER/1.webp",
      alt: "Single Drum Vibratory Roller",
    },
    images: [
      {
        src: "/products/ror/SINGLE DRUM VIBRATOR ROLLER/2.webp",
        alt: "Single Drum Vibratory Roller front view",
      },
      {
        src: "/products/ror/SINGLE DRUM VIBRATOR ROLLER/3.webp",
        alt: "Single Drum Roller for soil compaction",
      },
    ],
    ...
    specs: [
      ...
      { label: "Walking Speed", value: "0-4 Km/H" },
      { label: "Drum Size (Dia x W)", value: "425 x 600 mm" },
      { label: "Driving Motor", value: "Hydraulic" },
      { label: "Centrifugal Force", value: "16 KN" },
      { label: "Vibration Frequency", value: "70 HZ" },
      { label: "Water Tank Capacity", value: "15 L" },
      { label: "Weight", value: "330 Kg Approx" },
      {
        label: "Power Source",
        value: "Diesel Engine / Petrol Engine (Optional)",
      },
      { label: "Automation Grade", value: "Walk Behind Hydraulic Control" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    specs: [
      ...
      { label: "Height", value: "100 to 200 Feet" },
      { label: "Channel", value: "100mm x 50mm" },
      { label: "Motor Power", value: "10 HP, 3 Phase" },
      { label: "Wire Rope", value: "12mm" },
      { label: "Angle", value: "40mm x 40mm x 5mm" },
      { label: "Speed", value: "33 meter / min" },
...

  {
    ...
    model: "SSI-MH-01",
    image: {
      src: "/products/ml/MONKEY HOIST ( 200300 KG )/1.webp",
      alt: "Monkey Hoist 200 300 Kg",
    },
    images: [
      {
        src: "/products/ml/MONKEY HOIST ( 200300 KG )/2.webp",
        alt: "Monkey Hoist Machine for Construction",
      },
      {
        src: "/products/ml/MONKEY HOIST ( 200300 KG )/3.webp",
        alt: "Monkey Hoist with 200 Kg Capacity",
      },
    ],
    ...
    specs: [
      ...
      { label: "Lifting Height", value: "100 Feet" },
      { label: "Capacity", value: "200 / 300 Kg" },
      { label: "Motor Power", value: "3 HP, 5 HP, 3 Phase" },
      { label: "Wire Rope", value: "8mm, 10mm" },
      { label: "Rotation", value: "360°" },
      { label: "Brand", value: "SSI" },
    ],
  ...
  },
  {
    ...
    model: "SSI-MPH-02",
    image: {
      src: "/products/ml/MULTI PURPOSE HOIST/1.webp",
      alt: "Multi Purpose Hoist for Construction",
    },
    ...
    specs: [
      ...
      { label: "Gross Load", value: "1000Kg / 1500 Kg" },
      { label: "Net Load", value: "750Kg / 1200 Kg" },
      { label: "Wire Rope", value: "12mm" },
      { label: "Electric Motor", value: "10 HP / 12.5 HP" },
      { label: "Brake Motor", value: "Yes" },
      { label: "Speed", value: "30 m / min" },
      { label: "Max Height", value: "125 Mtr." },
      { label: "Tilting Bucket", value: "1 Ton / 1.5 Ton" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    images: [
      ...
      {
        src: "/products/ml/SUSPENDED PLATFORM (CRADLE)/3.webp",
        alt: "Suspended Platform with Safety Lock",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Weight Capacity", value: "800 Kg" },
      { label: "Safety Lock", value: "2 Nos" },
      { label: "Type for Safety Lock", value: "Anti Inclination Type" },
      { label: "Power", value: "1.8 Kw - 3 Phase" },
      { label: "Steel Wire Rope", value: "9.1mm / 8.3mm" },
      { label: "Suspension Mechanism", value: "Steel" },
      { label: "Platform Size", value: "2.5 + 2.5 + 1.5 + 1 = 7.5 Mtr" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-MH-02",
    image: {
      src: "/products/ml/MONKEY HOIST ( 5001000 KG )/1.webp",
      alt: "Monkey Hoist 500/1000 Kg for construction",
    },
    images: [
      {
        src: "/products/ml/MONKEY HOIST ( 5001000 KG )/2.webp",
        alt: "Heavy Duty Monkey Hoist for lifting construction materials",
      },
      {
        src: "/products/ml/MONKEY HOIST ( 5001000 KG )/3.webp",
        alt: "Monkey Hoist Machine with 360 degree rotation",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Lifting Height", value: "100 to 200 Feet" },
      { label: "Capacity", value: "500 / 1000 Kg" },
      { label: "Motor Power", value: "7.5 HP , 10 HP (3 Phase)" },
      { label: "Wire Rope", value: "10 mm / 12 mm" },
      { label: "Rotation", value: "360°" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-CC-02",
    image: {
      src: "/products/tv/CONCRETE CUTTER  ELECTRIC/4.webp",
      alt: "Electric Concrete Cutter Machine",
    },
    images: [
      {
        src: "/products/tv/CONCRETE CUTTER  ELECTRIC/3.webp",
        alt: "Concrete Cutting Machine with Blade",
      },
      {
        src: "/products/tv/CONCRETE CUTTER  PETROL DIESEL/3.webp",
        alt: "Concrete Cutting Machine with Blade",
      },
      {
        src: "/products/tv/CONCRETE CUTTER  PETROL DIESEL/2.webp",
        alt: "Concrete Cutting Machine with Blade",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Power", value: "7.5HP / 10HP 3 Phase" },
      { label: "Weight", value: "110 Kg Approx" },
      { label: "Max. Cutting Depth", value: "Up to 4 inch" },
      { label: "Blade Size", value: "12-20 inch" },
      { label: "Brand", value: "SSI" },
    ],
    metaTitle:
...

  {
    ...
    model: "SSI-BSV-02",
    image: {
      src: "/products/tv/DOUBLE BEAM SCREED VIBRATOR/1.webp",
      alt: "Double Beam Screed Vibrator",
    },
    ...
    specs: [
      ...
      { label: "Length", value: "4200mm" },
      { label: "Weight", value: "79Kg Approx" },
      { label: "Height", value: "Adjustable" },
      { label: "No of Bars", value: "2" },
      { label: "Motor", value: "Vibratory" },
...

  {
    ...
    model: "SSI-SV-01/02",
    image: {
      src: "/products/tv/SCREED VIBRATOR/1.webp",
      alt: "Screed Vibrator for concrete finishing",
    },
    images: [
      {
        src: "/products/tv/SCREED VIBRATOR/2.webp",
        alt: "Concrete Screed Vibrator with petrol engine",
      },
      {
        src: "/products/tv/SCREED VIBRATOR/3.webp",
        alt: "Electric Screed Vibrator machine for flooring",
      },
    ],
    ...
    specs: [
      ...
      { label: "Type", value: "Electric / Petrol Engine" },
      { label: "Max Output", value: "300*280" },
      { label: "Max Speed", value: "5200 RPM" },
      { label: "Blade Size", value: "2/3/4/5 Mtr" },
...

  {
    ...
    model: "SSI-ST-03",
    image: {
      src: "/products/tv/SLAB TROLLY  METRO TROLLY/1.webp",
      alt: "Slab Trolly Metro Trolly",
    },
    ...
    specs: [
      ...
      { label: "Capacity", value: "0.25 / 250 Ltr" },
      { label: "Bucket", value: "Tilting Bucket" },
      { label: "Track", value: "42.9mm Pipe with Bands" },
      { label: "Track Length", value: "50Ft To 100Ft (expandable)" },
...

  {
    ...
    model: "SSI-TR-01/02",
    image: {
      src: "/products/tv/TAMPING RAMMER/1.webp",
      alt: "Tamping Rammer Compaction Machine",
    },
    images: [
      {
        src: "/products/tv/TAMPING RAMMER/2.webp",
        alt: "Heavy-duty Tamping Rammer for soil compaction",
      },
      {
        src: "/products/tv/TAMPING RAMMER/3.webp",
        alt: "Construction Tamping Rammer in use",
      },
    ],
    description: [
    ...
    specs: [
      ...
      { label: "Ramming Frequency", value: "600-700 Times/Min" },
      { label: "Advance Speed", value: "10-13m/Min" },
      { label: "Bounce Height", value: "40-70mm" },
      { label: "Motor Power", value: "2.2Kw, 3HP, Voltage: 415V" },
...

  {
    ...
    model: "SSI-TS-01/02",
    image: {
      src: "/products/tv/TRUSS SCREEDS/1.webp",
      alt: "Concrete Truss Screed Machine",
    },
    ...
    specs: [
      ...
      { label: "Length", value: "3.1 Mtr" },
      { label: "Type", value: "Engine / Petrol / Electric" },
      { label: "Walking Mode", value: "Reversible" },
      { label: "Water Tank", value: "35 Ltr" },
      { label: "Rotation Speed of Motor", value: "2200/3000 RPM" },
      { label: "Total Weight", value: "600 Kg (Approx)" },
      { label: "Vibration Frequency", value: "70 Hz" },
      { label: "Brand", value: "SSI" },
    ],
...

  {
    ...
    model: "SSI-VDP-02",
    image: {
      src: "/products/tv/VACUUM DE-WATERING PUMP/img.webp",
      alt: "Vacuum De-Watering Pump for concrete flooring",
    },
    ...
    specs: [
      ...
      { label: "Weight", value: "79 Kg Approx" },
      { label: "Height", value: "Adjustable" },
      { label: "No of Bars", value: "2" },
      { label: "Motor", value: "Vibratory" },
      { label: "Power", value: "1 HP" },
...

  {
    ...
    model: "SSI-VB-02",
    image: {
      src: "/products/tv/VIBRATOR  PETROL  DIESEL/img.webp",
      alt: "Electric Concrete Vibrator with Nozzle",
    },
    ...
    specs: [
      ...
      { label: "Type", value: "Electric" },
      { label: "Power", value: "2HP / Single Phase / 3 Phase" },
      { label: "Nozzle", value: "40mm / 50mm / 60mm" },
...

  {
    ...
    model: "SSI-VT-02",
    image: {
      src: "/products/tv/VIBRATING TABLE/1.webp",
      alt: "Industrial Vibrating Table for Concrete Compaction",
    },
    ...
    specs: [
      ...
      { label: "Table Size", value: "10 x 2.5 ft" },
      { label: "Motor Power", value: "2HP Vibrator Motor" },
...

  {
    ...
    model: "SSI-WV-01/02",
    image: {
      src: "/products/tv/WHEEL BARROW  SINGLE  DOUBLE/1.webp",
      alt: "Wheel Barrow Single and Double Wheel for Construction",
    },
    images: [
      {
        src: "/products/tv/WHEEL BARROW  SINGLE  DOUBLE/2.webp",
        alt: "Single Wheel Barrow for construction material handling",
      },
      {
        src: "/products/tv/WHEEL BARROW  SINGLE  DOUBLE/3.webp",
        alt: "Double Wheel Barrow heavy duty for construction site",
      },
    ],
    description: [
      {
    ...
    specs: [
      ...
      { label: "Wheel", value: "1Nos / 2Nos" },
      { label: "Size", value: "L36 x W18 x H18" },
      { label: "Weight", value: "40Kg (Approx)" },
...

  {
    ...
    model: "SSI-PF-01",
    image: {
      src: "/products/tv/POWER FLOATER  POWER TROWEL/1.webp",
      alt: "Power Floater / Power Trowel for Concrete Finishing",
    },
    images: [
      {
        src: "/products/tv/POWER FLOATER  POWER TROWEL/2.webp",
        alt: "High-performance Power Trowel for smooth concrete finishing",
      },
      {
        src: "/products/tv/POWER FLOATER  POWER TROWEL/3.webp",
        alt: "Heavy-duty Power Floater for industrial flooring",
      },
    ],
    ...
    specs: [
      ...
      { label: "Type", value: "Diesel / Petrol / Electric" },
      { label: "Power", value: "5Hp / 6.5Hp Honda" },
      {
        label: "Plate Diameter",
        value: "36 inches / 42 inches / 900mm / 1000mm",
      },
  ...
  model: "SSI-AQI",
    ...
    images: [
      {
        src: "/products/aqi/2.webp",
        alt: "Digital AQI Monitor with real-time PM2.5 & PM10 detection",
      },
      {
        src: "/products/aqi/3.webp",
        alt: "Portable Air Quality Index Monitoring Device",
      },
    ],
    ...
    specs: [
      ...
      {
        label: "Usage/Application",
        value: "Indoor & Outdoor Air Quality Monitoring",
      },
  ...
  model: "SSI-AQI",
    ...
    images: [
      {
        src: "/products/aqi/aqidisplay/2.webp",
        alt: "Digital AQI display with real-time PM2.5 & PM10 detection",
      },
    ],
